...
function modelanimation(){
    ...
    dirLight.position.z =  32000*Math.cos(frame/400);
    dirLight.position.y =  32000*Math.sin(frame/400);
    dirLight.position.x =  -32000*Math.sin(frame/400)*Math.sin(Math.PI/180*6);
    sun.position.z =  32000*Math.cos(frame/400);
    sun.position.y =  32000*Math.sin(frame/400);
    sun.position.x =  -32000*Math.sin(frame/400)*Math.sin(Math.PI/180*6);
